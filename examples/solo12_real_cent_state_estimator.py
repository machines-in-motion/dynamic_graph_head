...
from dynamic_graph_head import ThreadHead, Vicon, SimHead, SimVicon, HoldPDController, StateEstimator, InitController
...
class EstimatorCentroidalControllerReplay(EstimatorCentroidalController):
    ...
    def warmup(self, thread):
        ...
        # Modify the force thresholds for different motions.
        thread.estimator.set_settings([1.6, 1.45])
